...
use polkadot_sdk::{
	...
	pallet_contracts, pallet_message_queue, pallet_revive, pallet_session, pallet_sudo,
	pallet_timestamp, pallet_transaction_payment, pallet_xcm, sp_core, sp_runtime,
	sp_runtime::{
